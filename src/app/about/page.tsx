  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-2 size-full">
        <Image
          src="/about-1.jpg" height={500} width={500} alt="Family sitting around a fire pit in front of cabin"
        />
      </div>

      <div className="col-span-2 size-full">
        <Image src="/about-2.jpg" height={500} width={500} alt="Family that manages The Wild Oasis" />
      </div>
